...
public class test {
	public static void main(String[] arg) {
	    ...
	    //      12  9  33 102
			...
			ParcialJ c = new ParcialJ();
			ListaGenerica<ArbolBinario<Integer>> l = new ListaEnlazadaGenerica<ArbolBinario<Integer>>();
			l = c.buscando(catorce, 14, 50);
			l.comenzar();
			while(!l.fin()) {
				System.out.println(l.proximo().getDato());
			}
